...
//Forward declarations to promise that the class will exist
class ElegantQueue;
...
public:
    ...
    //ElegantQueue class will need access.
    friend class ElegantQueue;
private:
    int job_id;
    int priority;
    std::time_t timestamp; 
    ElegantQueue* elegant_ptr; //Pointer to my UrgentQueue object
    uq_hook urgent_hook; //location in the Urgent heap
    tq_hook time_hook; //location in the Time heap
};
