...
int main() {
  ...
  cout << "\n";
  //test of remove matching elements
  cout << "v2 prior to removing matching elements:" << endl;
  v1.print();
  cout << "\nv2 after removal of matching elements" << endl;
  int num_occ = remove_matching_elements(v1,100);
  v1.print();
  cout << endl;
  cout << num_occ << " matching elements removed" << endl;
