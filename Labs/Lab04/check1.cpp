...
int main() {
  ...
  cout << "Check 1 & 3" << endl;
  v1.print();
  cout << v1.size() << " " << v1.alloc() << endl;
  cout << remove_matching_elements(v1, 100) << endl;
  cout << v1.size() << " " << v1.alloc() << endl;
  cout << remove_matching_elements(v1, 0) << endl;
  cout << v1.size() << " " << v1.alloc() << endl;
  cout << remove_matching_elements(v1, 40) << endl;
  cout << remove_matching_elements(v1, 43) << endl;
  v1.print();
  cout << endl;
